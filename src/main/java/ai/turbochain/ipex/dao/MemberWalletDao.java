...
//    int initSuperPaterner(@Param("memberId") long memberId);
     ...
     */
    @Modifying
    @Query("update MemberWallet wallet set wallet.balance = wallet.balance + :amount where wallet.id = :walletId and wallet.memberId = :memberId and wallet.balance = :balance")
    int transferIncreaseBalance(@Param("walletId") long walletId,@Param("memberId") Long memberId, @Param("amount") BigDecimal amount, @Param("balance") BigDecimal balance);
     ...
     */
    @Modifying
    @Query("update MemberWallet wallet set wallet.balance = wallet.balance - :amount where wallet.id = :walletId  and wallet.memberId = :memberId and wallet.balance >= :amount and wallet.balance = :balance")
    int transferDecreaseBalance(@Param("walletId") long walletId,@Param("memberId") Long memberId, @Param("amount") BigDecimal amount, @Param("balance") BigDecimal balance);
